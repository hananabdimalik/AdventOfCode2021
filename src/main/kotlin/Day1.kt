class Day1 {
    ...
    fun partTwo(input: List<Int> = puzzleInput): Int {
        val sum = input.mapIndexedNotNull { index, value ->
            if (input.size - 2 > index) {
                val position1 = input[index + 1]  //sub scripting an array
                val position2 = input[index + 2]
...
fun main() {
    println(Day1().partOne(Day1().puzzleInput))
    println(Day1().partTwo(Day1().puzzleInput))
}